...
export const createTurma = async (title, Qtd_Semana, Dia1, Dia2, Dia3, Local, MaxAlunos, Horario_de_inicio, Horario_de_termino) => {
  ...
  export const deleteRelatorio = async (relatorioId) => {
    try {
      ...
      console.error(`Erro ao excluir relatório com ID ${relatorioId}:`, error);
 ...
 export const salvarNovidade = async (novidadeData) => {
  ...
  export const createEvent = async (Title, Date_event, Description, Hora_event, type, Local) => {
    try {
      console.log('Dados recebidos por createMatch:', { Title, Date_event, Description, Hora_event, type, Local });
        const response = await databases.createDocument(
            appwriteConfig.databaseId,
...
export const salvarMetodologia = async (userId, newMetodologia) => {
  try {
    ...
    console.error('Erro ao salvar metodologia:', error.message);
...
export const getUsersById = async (userId) => {
  ...
  export const updateStatusPagamento = async (userId, planId, paymentId, endDate) => {
    try {
      console.log("Buscando aluno com userId:", userId);
      ...
      console.log("Atualizando documento:", documentId, "com status_pagamento:", planId);
      ...
      console.log("Status_pagamento atualizado com sucesso para o documento:", updatedAluno);
      return updatedAluno;
    } catch (error) {
      console.error("Erro ao atualizar o status_pagamento:", error.message);
...
export const updateEventConfirmados = async (eventId, confirmados) => {
  try {
    ...
    console.log('IDs confirmados:', confirmados);
 ...
 export const atualizarDiaCobranca = async (alunoId, diaCobranca) => {
  ...
  export const updateUserStatus = async (userId, { status }) => {
    try {
      ...
      console.log("Status atualizado com sucesso para o usuário:", userId);
    } catch (error) {
      console.error("Erro ao atualizar o status do usuário:", error.message);
...
export const updateAlunoStats = async (alunoId, { pique, forca, passe, finalizacao, geral }) => {
  try {
    console.log("Buscando atleta com userId:", alunoId);
    ...
    console.log("Atualizando documento:", documentId, "com os valores:", {
      pique,
      forca,
      passe,
      finalizacao,
    ...
    console.log("Atributos atualizados com sucesso para o aluno:", alunoId);
  } catch (error) {
    console.error("Erro ao atualizar os atributos do aluno:", error.message);
