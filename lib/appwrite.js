  ...
  try {
    ...
    if (role === 'profissional') {
      ...
      return {
        ...
        role: professional.role || 'user', // Assume que role será "user" se não estiver definida
      };
    } else if (role === 'atleta') {
      ...
      return {
        ...
        role: atleta.role || 'user', // Assume que role será "user" se não estiver definida
      };
      ...
      return {
        ...
        role: responsavel.role || 'user', // Assume que role será "user" se não estiver definida
      };
    }
  } catch (error) {
