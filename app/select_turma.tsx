import { View, Text, FlatList, Alert, TouchableOpacity, Modal, RefreshControl,StyleSheet, Pressable } from 'react-native';
  ...
  >
    ...
    <Text style={styles.buttonText}>Filtrar</Text>
        ...
        <TouchableOpacity 
          ...
          activeOpacity={0.7}
        >
          <Icon name="sort" size={20} color="#FFF" style={styles.buttonIcon} />
          <Text style={styles.buttonText}>
            {isSortedAsc ? 'Ordenar A-Z' : 'Ordenar Z-A'}
          </Text>
        </TouchableOpacity>
      </View>
      <FlatList
